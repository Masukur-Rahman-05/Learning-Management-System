...
//           <h2 className="text-3xl md:text-5xl font-bold text-green-400 mb-6 text-center px-5 animate-pulse">
//             Congratulations! Course Completed!
//           </h2>
...
//             <button
//               onClick={handleResetCourse}
//               className="px-6 py-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-50"
//             >
//               Restart Now
//             </button>
//             <button
...
//                 setIsCourseCompleted(false);
//               }}
//               className="px-6 py-3 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50"
//             >
//               Watch Again
//             </button>
//           </div>
...
//             Course Curriculum
//           </h1>
//           <div className="space-y-4 pr-4 max-h-[60vh] overflow-y-auto scrollbar-thin scrollbar-thumb-green-500 scrollbar-track-slate-700">
//             {courseDetails.curriculum.map((item, index) => {
//               const isViewed = courseProgress.some(
//                 (progress) => progress.lectureId === item._id
//               );
...
//                     isSelectable
//                       ? "cursor-pointer hover:bg-slate-700 hover:shadow-md"
//                       : "opacity-50 cursor-not-allowed"
//                   } ${
//                     index === currentVideoIndex
//                       ? "border-l-4 border-green-500 bg-slate-800"
    ...
    <div className="w-full min-h-screen  text-cyan-50 p-4 md:p-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8 justify-between items-start">
        <div className="w-full lg:w-3/5 space-y-4">
          ...
          <h2 className="text-2xl font-semibold text-cyan-400 bg-gray-800/50 p-4 rounded-lg backdrop-blur-sm">
            {lectureVideo?.title}
          </h2>
        </div>
        <div className="w-full lg:w-2/5 mt-8 lg:mt-0">
          <h1 className="text-3xl font-bold text-cyan-400 mb-6 bg-gray-800/50 p-4 rounded-t-lg backdrop-blur-sm">
            Course Curriculum
          </h1>
