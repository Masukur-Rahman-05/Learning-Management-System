...
const UserFAQ = () => {
    return (
      <div className="w-full md:w-1/2 md:px-4 lg:px-8   md:mx-auto my-10 text-white ">
        ...
        >
          <AccordionItem value="item-1">
            <AccordionTrigger className="text-violet-500 text-[13px] md:text-sm">
              What is E-Learning?
            </AccordionTrigger>
            <AccordionContent className="text-slate-400 text-[13px] md:text-sm">
