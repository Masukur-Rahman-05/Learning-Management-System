...
//               Sort by
//             </DropdownMenuTrigger>
//             <DropdownMenuContent className="bg-black text-white border-slate-600">
  ...
  return (
    <div className="w-screen min-h-screen flex gap-5 ">
      <div className="block xl:hidden">
        <DropdownMenu>
          <DropdownMenuTrigger className="bg-blue-600 text-white py-2 px-4 rounded-lg text-sm font-medium shadow-md">
            Filter
          </DropdownMenuTrigger>
